...
namespace TCUN
{
    class SwitchApple : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (Enabled)
            {
                using (SolidBrush brush = new SolidBrush(isOn ? Color.FromArgb(30,135,240) : Color.LightGray))
                ...
                using (SolidBrush circleBrush = new SolidBrush(Color.FromArgb(246, 240, 230)))
            ...
            {
                using (SolidBrush disableBrush = new SolidBrush(Color.FromArgb(207, 207, 207)))
                using (SolidBrush ellBrush = new SolidBrush(Color.FromArgb(179, 179, 179)))
                {
